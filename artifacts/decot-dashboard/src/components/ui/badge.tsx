...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary text-primary-foreground hover:bg-primary/80 box-glow",
        secondary:
        ...
        running: "border-transparent bg-primary/20 text-primary border border-primary/30 animate-pulse",
      },
    },
    defaultVariants: {
      variant: "default",
